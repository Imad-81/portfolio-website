...
export default function TechStack() {
    ...
    return (
        <section className="section py-32 overflow-hidden" onMouseMove={handleMouseMove} ref={containerRef}>
            <div className="max-w-[1200px] mx-auto px-4 relative h-[600px] flex items-center justify-center">

                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-0 opacity-20">
                    <h2 className="text-[12rem] font-bold text-white tracking-tighter leading-none mix-blend-overlay blur-sm">STACK</h2>
                </div>

                <div className="relative z-10 w-[300px] h-[300px]" style={{ perspective: '1000px' }}>
                    <motion.div
